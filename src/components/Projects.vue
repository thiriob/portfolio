  ...
  <div class="container p-0 md:p-10 md:p-2 md:px-20 m-auto">
    ...
    <div class="flex flex-wrap justify-center">
      ...
      <Card :img1="Proxima"
            ...
            link="https://play.google.com/store/apps/details?id=com.gamevrest.proximaCities"
      ...
      <Card :img1="BR"
            :img2= "PR"
            link="https://play.google.com/store/apps/details?id=com.InDustry.BarriersQuad&hl=en&gl=US"
